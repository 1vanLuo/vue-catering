(function(){
        ...
        H5lock.prototype.initDom = function(){
            ...
            var out = document.getElementById(this.outer);
            if(wrap && out) {
                var canvas = document.createElement('canvas');
                canvas.setAttribute('id','canvas');
                canvas.style.cssText = 'background-color: transparent;display: block;margin:30px auto';
